            ...
            <div className="container">
                <div className="row">
                    ...
                    <FeatureItem
                        icon=
                        {
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" color='#34A853' fill="currentColor" class="bi bi-bag-check" viewBox="0 0 16 16">
                    ...
                    <FeatureItem
                        icon=
                        {
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" color='#34A853' fill="currentColor" class="bi bi-box-seam" viewBox="0 0 16 16">
