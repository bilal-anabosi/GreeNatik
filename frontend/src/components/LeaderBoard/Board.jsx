...
const Board = () => {
    const calculateTimeLeft = () => {
        const difference = +new Date('2024/5/23 00:00:00') - +new Date();
        let timeLeft = {};
...
<div className ="container-fluid">
    <br/>
<div className="lh-1">
            <h1 className="mb-2 fw-bold fs">Leader Bord </h1>
    </div>
    <br/>
<div className="table-responsive-xl mb-6 mb-lg-0">
  ...
  <div className="deals-countdown " data-countdown="2024/10/10 00:00:00">
    ...
    <h1 className="mb-2 fw-bold fs-2">🏆</h1>
        ...
        <div> 
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" color='#9AA1A5CC' fill="currentColor" class="bi bi-exclamation-circle-fill"  viewBox="0 0 16 16">
