            ...
            <div className="row">
              <div className="col-md-6 align-self-center">
                <div className="text-center text-sm-center text-md-end mb-4">
                  <h2 className="text-grad display-1 fw-bold mb-4">{t('aboutus.years')}</h2>
                </div>
              </div>
              <div className="col-md-6 align-self-center text-center text-sm-center text-md-start">
                <p className="pe-0 pe-lg-5">{t('aboutus.description1')}</p>
                <p className="pe-0 pe-lg-5">{t('aboutus.description2')}</p>
            ...
            <div className="row mt-4">
              ...
              <div className="col-md-4">
                <div className="feature-box h-100 icon-primary">
                  ...
                  <br/>
                  <h3 className="feature-box-title">{t('aboutus.feature1Title')}</h3>
                  <p className="feature-box-desc">{t('aboutus.feature1Desc')}</p>
                </div>
              </div>
              {/* feature 2 */}
              <div className="col-md-4">
                <div className="feature-box h-100 icon-primary">
                  <div className="feature-box-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width={50} height={50} fill="currentColor" className="bi bi-bag-heart" viewBox="0 0 16 16">
                  ...
                  <br/>
                  <h3 className="feature-box-title">{t('aboutus.feature2Title')}</h3>
                  <p className="feature-box-desc">{t('aboutus.feature2Desc')}</p>
                </div>
              </div>
              {/* feature 3 */}
              <div className="col-md-4">
                <div className="feature-box h-100 icon-primary">
                  <div className="feature-box-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width={50} height={50} fill="currentColor" className="bi bi-emoji-wink" viewBox="0 0 16 16">
                  ...
                  <br/>
                  <h3 className="feature-box-title">{t('aboutus.feature3Title')}</h3>
                  <p className="feature-box-desc">{t('aboutus.feature3Desc')}</p>
                </div>
              </div>
            </div>
          </div>
