...
<div className="so">
    <div className="card-header border-0 pb-0">
        <br/>
        <h1 className="h4 card-title mb-0">Do you have any leftovers? <br/>
...
<div>
    ...
    <div className="d">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" color='#333333CC' fill="currentColor" className="bi bi-exclamation-circle-fill"  viewBox="0 0 16 16">
