...
const Orderpage = ({ images, ProductTitle, ProductSize, orderCode, date, price, items }) => {
return (
    <tr>
        <td className="align-middle border-top-0 w-0">
            <a href="# "><img src={images} alt="Ecommerce" className="icon-shape icon-xl" /></a>
        </td>
    ...
    <td className="align-middle border-top-0">
        <a href="# " className="text-inherit">{orderCode}</a>
    </td>
            ...
            <td className="align-middle border-top-0">{items}</td>
                <td className="align-middle border-top-0">{price}</td>
                    <td className="text-muted align-middle border-top-0">
                        <a href="# " className="text-inherit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View">
