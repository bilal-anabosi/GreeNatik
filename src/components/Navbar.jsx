...
<div style={{background:'#F1F6FA'}}> 
  ...
  <nav className="navbar py-lg-4 py-3 px-0 border-bottom navbar-menu">
    <div className="container-fluid">
      <div className="row w-100 align-items-center g-0 gx-lg-3">
        <div className="col-xxl-10 col-lg-8">
          <div className="d-flex align-items-center">
            <button className="navbar-toggler collapsed d-none d-lg-block" type="button" data-bs-toggle="offcanvas" data-bs-target="#navbar-default2" aria-controls="navbar-default2">
              <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} fill="currentColor" className="bi bi-text-indent-right text-primary" viewBox="0 0 16 16">
                <path d="M2 3.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm10.646 2.146a.5.5 0 0 1 .708.708L11.707 8l1.647 1.646a.5.5 0 0 1-.708.708l-2-2a.5.5 0 0 1 0-.708l2-2zM2 6.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5zm0 3a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5zm0 3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5z" />
              </svg>
            </button>
            <a className="navbar-brand d-none d-lg-block ms-4" href="../../index.html"><big>
              <img src="/favicon.ico" alt="eCommerce "width={32} height={32} />GreeNatik</big>
            </a>
            <div class="container">
            <div class="row justify-content-center">
             ...
             <input class="form-control rounded-start" type="search" placeholder="Search for anything" aria-label="Search" />
          ...
          <div className="d-flex justify-content-between w-100 d-lg-none align-items-center">
            <button className="navbar-toggler collapsed " type="button" data-bs-toggle="offcanvas" data-bs-target="#navbar-default2" aria-controls="navbar-default2">
            <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} fill="currentColor" className="bi bi-text-indent-right text-primary" viewBox="0 0 16 16">
                <path d="M2 3.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm10.646 2.146a.5.5 0 0 1 .708.708L11.707 8l1.647 1.646a.5.5 0 0 1-.708.708l-2-2a.5.5 0 0 1 0-.708l2-2zM2 6.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5zm0 3a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5zm0 3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5z" />
              </svg>
            </button>
            <a className="navbar-brand" href="../../index.html">
              <img src="/favicon.ico" alt="e" width={32} height={32}/> GreeNatik
            </a>
        ...
        <div className="col-xxl-2 col-lg-4 d-flex align-items-center justify-content-end ">
          ...
          <div className="list-inline  d-lg-block d-none">
            ...
            <div className="list-inline-item">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-piggy-bank" viewBox="0 0 14 14">
      ...
      {/*icons end*/}
      {/*sidebar */}
      <div className="offcanvas offcanvas-start p-4 w-xxl-20 w-lg-30" id="navbar-default2">
        <div className="d-flex justify-content-between align-items-center mb-2 ">
          <a className="text-decoration-none text-black"href="../../index.html"><img src="favicon.ico" alt="eCommerce HTML Template"  width={32} height={32}/>GreeNatik</a> 
