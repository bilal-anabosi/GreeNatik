...
const CreateNewBlog = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:4000/blog/create-new-blog', data, {
                headers: {
                                                    ...
                                                    <div className="card-body p-0">
                                                        ...
                                                        <div className="row">
                                                            <div className="mb-3 col-lg-6">
                                                                ...
                                                                <input type="text" className="form-control" placeholder="In minutes" required name="readingTime" value={formData.readingTime} onChange={handleInputChange} />
                                                            </div>
                                                            <div className="mb-3 col-lg-6">
                                                                <label className="form-label">Category</label>
                                                                <select className="form-select" name="blogCategory" value={formData.blogCategory} onChange={handleInputChange}>
